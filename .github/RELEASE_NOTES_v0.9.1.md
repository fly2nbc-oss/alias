...
First public release: **Tauri desktop app** for pseudonymizing text and spreadsheets (local ONNX NER, alias mapping, encode/decode, import including Excel).

### Downloads (Linux)

| Asset | Description |
|-------|-------------|
| `Alias_0.9.1_amd64.deb` | Debian/Ubuntu-style distros (amd64) |
